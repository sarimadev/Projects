...
* imblearn, scikit-learn, tensorflow, keras, librosa, xgboost, catboost etc.
...
The results showcase the effectiveness of the models in accurately classifying emotional states from speech data. Key findings and insights from the project are visualized to illustrate model performance.
